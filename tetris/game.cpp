...
void game::renderPiece( SDL_Surface *screen, int x, int y, int id)
{
...
void game::update( taskmanager *tskmgr )
{
	...
	{
		cout << "score = " << score << '\n';
		highscore::instance()->setCurrentScore( score );
...
void game::draw( taskmanager *tskmgr )
{
